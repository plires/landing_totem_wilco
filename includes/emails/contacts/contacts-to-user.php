...
<head>
  ...
  <title>Wilco - Monitoreo de Alarmas</title>
    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto; background-color: #fefefe;" class="email-container">
      ...
      <tr style="background-color: #fefefe;">
        <td style="padding: 40px; padding-top: 0px;">
          ...
          <h2 class="fallback-font" style="margin: 0 0 20px 0; padding-top: 40px; font-family: 'Montserrat', sans-serif; font-size: 22px; line-height: 32px; color: #e20613; text-align: center; font-weight: 700; text-transform: uppercase;">
          ...
          <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #000000; text-align: left; font-weight: 400;">
            ¡Gracias por tu interés en nuestros productos de seguridad! recibimos tu consulta y a la brevedad te estará contactando un asesor especializado para brindarte toda la información necesaria.
          </p>
      ...
      <!-- Boton : BEGIN -->
      <tr style="background-color: #e20613;">
        <td style="background-color: #e20613; text-align: center; padding: 40px;">
